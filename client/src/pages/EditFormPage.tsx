...
export default function EditFormPage() {
  ...
  }, [isEdit, isSuccess, edit, loaded, packages]);
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "0 1rem 3rem" }}>
        ...
        <Section title="Expenses" icon={<Building2 size={18} />}>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "1rem", alignItems: "flex-end" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", flex: "1 1 200px", maxWidth: "300px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", flex: "2 1 300px" }}>
              <label style={labelStyle}>Note (optional)</label>
              <input
                type="text"
                value={form.expenseNote || ""}
                onChange={(e) => setForm((f) => ({ ...f, expenseNote: e.target.value }))}
                placeholder="e.g. 5000 petrol charges"
                style={inputCls}
              />
            </div>
          </div>
